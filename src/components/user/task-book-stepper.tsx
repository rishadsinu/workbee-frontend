...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators = false }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#222222ff', color: '#ffffffff' },
          active: { scale: 1, backgroundColor: '#d9d9d9ff', color: '#242426ff' },
          complete: { scale: 1, backgroundColor: '#2b2a2eff', color: '#3b82f6' }
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: '#202022ff' }
  };
